...
Little bit of a messy repo, but basically how I chose to implement https://iffybooks.net/zines/ - "Spread ideas with a pocket wi-fi portal" with a little help from AI's
